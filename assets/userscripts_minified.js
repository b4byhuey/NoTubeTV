  ...
  class SponsorBlockHandler {
    ...
    async init() {
      ...
      const resp = await new Promise((resolve) => {
        ...
        if (typeof NetworkBridge !== "undefined" && typeof NetworkBridge.fetch === "function") NetworkBridge.fetch(
...
try {
  ...
  console.warn("SponsorBlock parse error:", e);
  return;
}
      ...
      exitButton.addEventListener(
        ...
        (e) => {
          if (
            ...
            typeof ExitBridge !== "undefined" && typeof ExitBridge.onExitCalled === 'function' &&
  ...
  document.addEventListener("keydown", function (event) {
    if (event.key === "ArrowRight") {
      ...
      if (searchBar && isFocused) {
        if (typeof modernUI === 'function') modernUI(); // from 'userscript.js'
